...
ActiveRecord::Schema.define(version: 20160513193009) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "role"
    t.integer  "total_pto"
    t.integer  "used_pto",               default: 0
    t.integer  "carryover_pto",          default: 0
    t.integer  "bonus_pto",              default: 0
